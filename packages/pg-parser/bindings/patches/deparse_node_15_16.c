...
//
// This variant targets PG 15 and PG 16 where deparseExpr takes 2 params.
// A separate deparse_node_17.c exists for PG 17+ (3-param deparseExpr).
